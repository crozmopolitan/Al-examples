table 50110 MyTableFlowFieldTest
{
    fields
    {
        ...
        field(4;OptionFF;Boolean)
        {
            ...
            CalcFormula=exist(MyTestData where (Type = Filter(="MyType"), "No." = field("No."), "StatusOption"=filter(<>"Test3"), "StatusOption"=filter(<>"Test5")));
        ...
        field(5;DateFF;Boolean)
        {
            ...
            CalcFormula=exist(MyTestData where (Type = Filter(="MyType"), "No." = field("No."), MyDate = field("MyDate")));
